...
if not os.path.isdir(imc_path):
    os.makedirs(imc_path)
touch(server_path + '/__init__.py')
touch(imc_path + '/__init__.py')

# Copy files from library folder to imc_path
copy_files(os.getcwd() + '/library', imc_path)
